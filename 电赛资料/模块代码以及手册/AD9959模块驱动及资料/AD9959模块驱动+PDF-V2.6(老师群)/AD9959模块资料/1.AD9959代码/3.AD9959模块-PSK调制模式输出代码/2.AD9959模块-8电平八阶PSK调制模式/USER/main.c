/**********************************************************
                       康威电子
功能：stm32f103rct6控制AD9959模块8电平八阶PSK调制
...
//	本函数只能选择CH0做8电平调制，未做任意通道兼容，具体方法请参考AD9959芯片手册22-23页，操作FR1[14:12]为对应值。
	...
	while(1)
	{
		...
		PS0=0;PS1=0;PS2=0;//PS0-PS2控制CH0；CH0输出相位1
		delay_ms(2);
		
		PS0=0;PS1=0;PS2=1;//CH0输出相位2
		delay_ms(2);
		
		PS0=0;PS1=1;PS2=0;//CH0输出相位3
		delay_ms(2);
		
		PS0=0;PS1=1;PS2=1;//CH0输出相位4
		delay_ms(2);		
		
		PS0=1;PS1=0;PS2=0;//CH0输出相位5
		delay_ms(2);
		
		PS0=1;PS1=0;PS2=1;//CH0输出相位6
		delay_ms(2);
	
		PS0=1;PS1=1;PS2=0;//CH0输出相位7
		delay_ms(2);
		
		PS0=1;PS1=1;PS2=1;//CH0输出相位8
		delay_ms(2);
	}
