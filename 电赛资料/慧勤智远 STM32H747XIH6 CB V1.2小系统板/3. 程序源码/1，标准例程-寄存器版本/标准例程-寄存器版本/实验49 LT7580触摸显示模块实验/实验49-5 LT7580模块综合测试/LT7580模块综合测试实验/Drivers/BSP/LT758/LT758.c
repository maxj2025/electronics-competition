/******************************************************************************
  ...
  * @version   V1.0.0
  * @date      2024-09-10
  * @brief     LT758x Register Setting Functions
*******************************************************************************/
...
void LT758_SW_Reset(void) //IC Reset¡A¦ý
{
	unsigned char temp;
...
{
/*  
	0: PLL disable; PLL parameters can be changed.
    1: PLL enable; PLL parameters can NOT be changed.		
*/
...
//[0Fh]=========================================================================
void XPDAT18_Set_GPIO_D7(void)   //Set PD[18] as GPIO
{
/*
	XPDAT[18] ¡V 
	0: GPIO-D7
...
void XPDAT18_Set_KOUT4(void)    //Set PD[18] as KO[4]
{
/*
	XPDAT[18] ¡V
	0: GPIO-D7
...
void XPDAT17_Set_GPIO_D5(void)	//Set PD[17] as GPIO
{
/*
	XPDAT[17] ¡V 
	0: GPIO-D5
...
void XPDAT17_Set_KOUT2(void) 	//Set PD[17] as KO[2]
{
/*
	XPDAT[17] ¡V 
	0: GPIO-D5
...
void XPDAT16_Set_GPIO_D4(void)	//Set PD[16] as GPIO
{
/*
	XPDAT[16] ¡V 
	0: GPIO-D4
...
void XPDAT16_Set_KOUT1(void)	//Set PD[16] as KO[1]
{
/*
	XPDAT[16] ¡V 
	0: GPIO-D4
...
void XPDAT9_Set_GPIO_D3(void)	//Set PD[9] as GPIO 
{
/*
	XPDAT[9] ¡V 
	0: GPIO-D3
...
void XPDAT9_Set_KOUT3(void)		//Set PD[9] as KO[3]
{
/*
	XPDAT[9] ¡V 
	0: GPIO-D3
...
void XPDAT8_Set_GPIO_D2(void)	//Set PD[8] as GPIO
{
/*
	XPDAT[8] ¡V 
	0: GPIO-D2
...
void XPDAT8_Set_KIN3(void)		//Set PD[8] as KI[3]
{
/*
	XPDAT[8] ¡V 
	0: GPIO-D2
...
void XPDAT2_Set_GPIO_D6(void)	//Set PD[2] as GPIO
{
/*
	XPDAT[2] ¡V 
	0: GPIO-D6
...
void XPDAT2_Set_KIN4(void)		//Set PD[2] as KI[4]
{
/*
...
void XPDAT1_Set_GPIO_D1(void)	//Set PD[1] as GPIO 
{
/*
	XPDAT[1] ¡V 
	0: GPIO-D1
...
void XPDAT1_Set_KIN2(void)		//Set PD[1] as KI[2]
{
/*
	XPDAT[1] ¡V
	0: GPIO-D1
...
void XPDAT0_Set_GPIO_D0(void)	//Set PD[0] as GPIO
{
/*
	XPDAT[0] ¡V 
	0: GPIO-D0
...
void XPDAT0_Set_KIN1(void)		//Set PD[0] as KI[1]
{
	/*
...
void Alpha_Enable(void)
{
/*
	8bpp Color Mode
	0: 8bpp-RGB232
	1: 8bpp-Index, switching the index color to 24bpp color
*/
	unsigned char temp;
	LCD_CmdWrite(0x10);
	temp = LCD_DataRead();
...
/*
	...
	This register specifies the horizontal non-display period, also known as [Back Porch].
	Horizontal non-display period(pixels) = (HNDR + 1) * 8 + HNDFTR

	[17h] Horizontal Non-Display Period Fine Tuning(HNDFT) [3:0]
	This register specifies the fine tuning for horizontal non-display period; it is used 
	to support the SYNC mode panel. Each level of this modulation is 1-pixel.
	Horizontal non-display period(pixels) = (HNDR + 1) * 8 + HNDFTR
*/
	unsigned char temp;
	if (WX < 8)
...
/*
	...
	The starting position from the end of the display area to the beginning of 
	HSYNC. Each level of this modulation is 8-pixel, also known as [Front Porch].
...
/*
	...
	The starting position from the end of the display area to the beginning of VSYNC.
...
/*
	...
	The value is physical pixel number. Maximum value is 8192 pixels
*/
...
/*
	...
	X-axis coordination plus Horizontal display width cannot large than 8191.
...
/*
	...
	X-axis coordination should be less than the horizontal display width.
	The setting value will be assigned to the PIP window set by REG[10] bit4. 
...
/*
	...
	0 : Disable.
	1 : Enable.
	Text cursor & Graphic cursor should not be enabled simultaneously.
	Graphic cursor has higher priority than Text cursor if both are enabled at the same time.
*/
	unsigned char temp;
...
/*
	...
	Based on the Main Window Coordinate System.
*/
...
//[44h]========================================================================================
void Set_Graphic_Cursor_Color_0(unsigned char temp)
{
/*
...
/*
	...
	Based on Canvas Image Coordinate System. 
	Unit: Pixel
*/
...
/*
	...
	00 : Draw Lower Left Ellipse Curve
	01 : Draw Upper Left Ellipse Curve
	10 : Draw Upper Right Ellipse Curve
	11 : Draw Lower Right Ellipse Curve 
*/
...
/*
	...
	//If XTEST[0] is set to high, then XPWM[1] will become panel scan clock input.
*/
...
/*
	...
	Compare buffer register has 16 bits.
	When the timer is equal to or less than the value of the Compare buffer register,
	and the PWM0 Timer output inverter is off, PWM0 will output high level.
*/
	LCD_CmdWrite(0x88);
	LCD_DataWrite(WX);
	LCD_CmdWrite(0x89);
...
/*
	...
	Count buffer register has 16 bits.
	When the timer is equal to 0, and the Reload_En bit is enabled, PWM timer will 
	reload the Count buffer register.
	Users may read back the timer's real time value after the PWM timer starts counting.
*/
	LCD_CmdWrite(0x8A);
	LCD_DataWrite(WX);
	LCD_CmdWrite(0x8B);
...
/*
	...
	Compare buffer register has 16 bits.
	When the timer is equal to or less than the value of the Compare buffer register,
	and the PWM1 Timer output inverter is off, PWM1 will output high level.
*/
	LCD_CmdWrite(0x8C);
	LCD_DataWrite(WX);
	LCD_CmdWrite(0x8D);
...
*/
	...
	do
	{
		temp = LCD_StatusRead();
		busy_count++;
		if(busy_count>500000)
		{
			LT758_SW_Reset();
			LT758_PWM1_Init(1,0,100,100,100);//turn on backlight
		}
	} while (temp & 0x08);
}
...
/*
	...
	0001 : Reserved 
	0010 : Memory copy (move) with ROP
	0011 : Reserved 
	0100 : MCU Write with Chroma Key (w/o ROP) 
	0101 : Memory Copy (move) with Chroma Key (w/o ROP)
	0110 : Pattern Fill with ROP
	0111 : Pattern Fill with chroma key (w/o ROP)
	1000 : MCU Write with Color Expansion (w/o ROP)
	1001 : MCU Write with Color Expansion and Chroma Key (w/o ROP)
	1010 : Memory Copy with Opacity (w/o ROP)
	1011 : MCU Write with Opacity (w/o ROP)
	1100 : Solid Fill (w/o ROP)
	1101 : Reserved
	1110 : Memory Copy with Color Expansion
	1111 : Memory Copy with Color Expansion and Chroma Key (w/o ROP)
*/
	unsigned char temp;
	LCD_CmdWrite(0x91);
	temp = LCD_DataRead();
...
void Check_Busy_JPG_DMA(void)
{
	...
	do
	{
		...
		if(retty >= 1000000)
		{
			LCD_RegisterWrite(0xB6,LCD_RegisterRead(0xb6)|0x01);		// Set back to regular DMA
			LT758_SW_Reset();
			LT758_PWM1_Init(1,0,100,100,100);//turn on backlight
			return;
		}
...
{
	unsigned char temp;	
	while((read_758_reg(0xba) & 0x20) == 0x20);	
	LCD_CmdWrite(0xB8);
	temp=LCD_DataRead();
	return temp;
}
...
//0: inactive (nSS port will be high)
...
{
	temp &= 0x0f;			//bit[3:0] for setting the SPI clock cycle
	LCD_CmdWrite(0xBB);
	temp |= (LCD_DataRead() & 0xf0);
	LCD_DataWrite(temp);
}
...
/*
	...
	These bits define serial flash address [7:0][15:8][23:16][31:24]
*/
	LCD_CmdWrite(0xBC);
	LCD_DataWrite(Addr);
	LCD_CmdWrite(0xBD);
...
/*
	...
	[1:0]Fix at 0
	These bits define SDRAM address [7:0][15:8][23:16][31:24]
*/
	LCD_CmdWrite(0xC0);
	LCD_DataWrite(Addr);
	LCD_CmdWrite(0xC1);
...
/*
	...
	which supports English and most of European languages.
	00b : ISO/IEC 8859-1
	01b : ISO/IEC 8859-2
	10b : ISO/IEC 8859-3
	11b : ISO/IEC 8859-4
...
//[D0h]=========================================================================
void Character_Line_Gap(unsigned char temp)
{
/*
	[bit4:0]
	Character Line Gap Setting
	Unit: pixel
*/
	LCD_CmdWrite(0xD0);
	LCD_DataWrite(temp);
...
//[D1h]=========================================================================
void Set_Character_to_Character_Space(unsigned char temp)
{
/*
	[bit5:0]
	Character to Character Space Setting 
	Unit: pixel
*/
	LCD_CmdWrite(0xD1);
	LCD_DataWrite(temp);
...
//[E5h][E6h]====================================================================
void LT758_I2CM_Clock_Prescale(unsigned short WX)
{
/*
...
//[E7h]=========================================================================
void LT758_I2CM_Transmit_Data(unsigned char temp)
{
/*
...
//[E8h]=========================================================================
unsigned char LT758_I2CM_Receiver_Data(void)
{
/*
...
/*
	...
	Note : This bit is always read as 0.
	[bit5]
	READ(READ and WRITE cannot be used simultaneously)
	Read from slave and be cleared by hardware automatically
	Note : This bit is always read as 0.
	[bit4]
	WRITE(READ and WRITE cannot be used simultaneously)
	Write to slave and be cleared by hardware automatically
	Note : This bit is always read as 0.
	[bit3] ACKNOWLEDGE
	When used as a I2C master receiver
	0 : Sent ACK.
	1 : Sent NACK.
	Note : This bit is always read as 0.
	[bit0] Noise Filter
...
void LT758_I2CM_Read_With_Ack(void)
{
...
void LT758_I2CM_Read_With_Nack(void)
{
...
void LT758_I2CM_Write_With_Start(void)
{
	LCD_CmdWrite(0xE9);
#ifdef Disable_I2CM_Noise_Filter
	LCD_DataWrite(0x90);
...
//[EAh]=========================================================================
unsigned char LT758_I2CM_Check_Slave_ACK(void)
{
/*
	[bit7]
...
unsigned char LT758_I2CM_Bus_Busy(void)
{
/*
	[bit6]
	I2C Bus is Busy
...
unsigned char LT758_I2CM_transmit_Progress(void)
{
/*
	[bit6]
	0=Complete
...
/*
 ...
 1= Arbitration lost
*/
unsigned char LT758_I2CM_Arbitration(void)
{
/*
	[bit6]
	I2C Bus is Busy
...
void Key_Scan_Freq(unsigned char setx)
{
/*
...
/*
	Key Strobe Data 1
	The corresponding key code 1 is pressed.
*/
	unsigned char temp;
	LCD_CmdWrite(0xFD);
	temp = LCD_DataRead();
...
/*
	Key Strobe Data 2
	The corresponding key code 2 is pressed.
*/
	unsigned char temp;
	LCD_CmdWrite(0xFE);
	temp = LCD_DataRead();
...
unsigned char Read_Key_Strobe_Data_3(void)
{
/*
	Key Strobe Data 3
	The corresponding key code 3 is pressed.
*/
	unsigned char temp;
	LCD_CmdWrite(0xFF);
	temp = LCD_DataRead();
