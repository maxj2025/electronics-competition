...
#define OV_RESET_GPIO_PIN               SYS_GPIO_PIN8
#define OV_RESET_GPIO_CLK_ENABLE()      do{ RCC->AHB4ENR |= 1 << 8; }while(0)   /* PI口时钟使能 */

#define OV_PWDN_GPIO_PORT               GPIOG
#define OV_PWDN_GPIO_PIN                SYS_GPIO_PIN7
#define OV_PWDN_GPIO_CLK_ENABLE()       do{ RCC->AHB4ENR |= 1 << 6; }while(0)   /* PG口时钟使能 */

/******************************************************************************************/

/* IO控制函数 */
#define OV2640_RST(x)        sys_gpio_pin_set(OV_RESET_GPIO_PORT, OV_RESET_GPIO_PIN, x)  /* 复位控制信号 */
#define OV2640_PWDN(x)       sys_gpio_pin_set(OV_PWDN_GPIO_PORT, OV_PWDN_GPIO_PIN, x)    /* POWER DOWN控制信号 */
...
#define Image_FlipVer       0           /* 图像垂直翻转使能 1;使能 0:失能 */
