    ...
    while (1)
    {
        ...
        {            
            if (applenth)
            {
                ...
                if (((*(volatile uint32_t *)(0X24001000 + 4)) & 0xFF000000) == 0x08000000)  /* 判断是否为0X08XXXXXX */
                {
        ...
        if (key == KEY0_PRES)   /* KEY0按下 */
        {
            ...
            if (((*(volatile uint32_t *)(0x24001000 + 4)) & 0xFF000000) == 0x24000000)   /* 判断是否为0X24XXXXXX */
            {
                iap_load_app(0x24001000);                                                /* 执行SRAM APP代码 */
            }
            else
            {
