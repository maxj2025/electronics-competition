    ...
    for (YCnt = 0, YPos = y0, Pass = 0; YCnt < Height; YCnt++)
    {
        ...
        for (XPos = x0; XPos <= XEnd; XPos++)
        {
            ...
            else
            {
                if (Cnt)
                {
                    ...
                    {
                        if (lcdltdc.pixformat == 0X01 || lcdltdc.pixformat == 0X00)  /* 颜色像素格式为ARGB8888或RGB888 */
                        {
                            pic_phy.draw_hline(XPos - Cnt - 1, YPos, Cnt + 1, rgb565torgb888(*(pTrans + OldIndex)) | 0XFF000000);  /* 将RGB565颜色转换成RGB888颜色，ARGB8888默认不透明(显示RGB888的颜色) */
                        }
                        else
                        {
                    ...
                    else if (Disposal == 2)
                    {
                        if (lcdltdc.pixformat == 0X01 || lcdltdc.pixformat == 0X00)  /* 颜色像素格式为ARGB8888或RGB888 */
                        {
                            pic_phy.draw_hline(XPos - Cnt - 1, YPos, Cnt + 1, rgb565torgb888(bkcolor) | 0XFF000000);
                        }
                        else
                        {
                ...
                else
                {
                    if (OldIndex >= 0)
                    {
                        if (OldIndex != Transparency)
                        {
                            if (lcdltdc.pixformat == 0X01 || lcdltdc.pixformat == 0X00)  /* 颜色像素格式为ARGB8888或RGB888 */
                            {
                                pic_phy.draw_point(XPos - 1, YPos, rgb565torgb888(*(pTrans + OldIndex)) | 0XFF000000);
                            }
                            else
                            {
                        ...
                        else if (Disposal == 2)
                        {
                            if (lcdltdc.pixformat == 0X01 || lcdltdc.pixformat == 0X00)  /* 颜色像素格式为ARGB8888或RGB888 */
                            {
                                pic_phy.draw_point(XPos - 1, YPos, rgb565torgb888(bkcolor) | 0XFF000000);
                            }
                            else
                            {
        ...
        if ((OldIndex != Transparency) || (Disposal == 2))
        {
            ...
            if (Cnt)
            {
                if (lcdltdc.pixformat == 0X01 || lcdltdc.pixformat == 0X00)  /* 颜色像素格式为ARGB8888或RGB888 */
                {
                    pic_phy.draw_hline(XPos - Cnt - 1, YPos, Cnt + 1, rgb565torgb888(ColorIndex) | 0XFF000000);
                }
                else
                {
            ...
            {  
                if (lcdltdc.pixformat == 0X01 || lcdltdc.pixformat == 0X00)  /* 颜色像素格式为ARGB8888或RGB888 */
                {
                    pic_phy.draw_point(XEnd, YPos, rgb565torgb888(ColorIndex) | 0XFF000000);
                }
                else
                {
