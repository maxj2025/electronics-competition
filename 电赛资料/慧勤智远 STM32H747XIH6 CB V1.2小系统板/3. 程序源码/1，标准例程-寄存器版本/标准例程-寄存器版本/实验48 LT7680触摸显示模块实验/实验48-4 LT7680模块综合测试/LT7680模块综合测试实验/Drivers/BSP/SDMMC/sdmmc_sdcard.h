...
#define SDMMC_TRANSFER_CLK_DIV    3         /* SDMMC传输频率 240M / (3 * 2) = 40Mhz,该值太小可能会导致读写文件出错 */


/******************************************************************************************/
/* SDMMC1的信号线: SD1_D0 ~ SD1_D3/SD1_CLK/SD1_CMD 引脚 定义 
 * 如果你使用了其他引脚做SDMMC1的信号线,修改这里宏定义即可适配.
...
extern uint8_t filesave_flag;       /* 文件保存标志 */
...
SDCardState sdmmc_get_status(void);                                  /* 获取SD卡的状态 */                                        
