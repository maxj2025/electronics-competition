...
void sccb_init(void)
{
    ...
    gpio_init_struct.Pin = SCCB_SCL_GPIO_PIN;              /* SCL引脚 */
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_PP;           /* 推挽输出 */
    gpio_init_struct.Pull = GPIO_PULLUP;                   /* 上拉 */
    gpio_init_struct.Speed = GPIO_SPEED_FREQ_HIGH;         /* 快速 */
    HAL_GPIO_Init(SCCB_SCL_GPIO_PORT, &gpio_init_struct);  /* SCL引脚模式设置 */

    gpio_init_struct.Pin = SCCB_SDA_GPIO_PIN;              /* SDA引脚 */
    gpio_init_struct.Mode = GPIO_MODE_OUTPUT_OD;           /* 开漏输出 */
    HAL_GPIO_Init(SCCB_SDA_GPIO_PORT, &gpio_init_struct);  /* SDA引脚模式设置 */
