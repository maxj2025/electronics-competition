...
RESTART:
    text_show_string(30, 5, 200, 16, "慧勤智远STM32开发板", 16, 0, RED);
    text_show_string(30, 25, 200, 16, "拼音输入法实验", 16, 0, RED);
    text_show_string(30, 45, 200, 16, "WKS SMART", 16, 0, RED);
    text_show_string(30, 65, 200, 16, "KEY0: 翻页", 16, 0, RED);
    text_show_string(30, 85, 200, 16, "WK_UP: 清除", 16, 0, RED);    
    ...
    else if (lcddev.id == 0X5510 || lcddev.id == 0X9806 || lcdltdc.pheight >= 480)
    {
        kbdxsize = 140;
        kbdysize = 70;
    }
    ...
    {        
        i++;
        delay_ms(10);
        key = py_get_keynum(30, 195);           /* 得到触摸屏的输入 */
