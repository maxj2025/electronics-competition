...
/* 硬件平台软硬件版本定义 */
#define HARDWARE_VERSION            12          /* 硬件版本,放大10倍,如1.0表示为10 */
#define SOFTWARE_VERSION            120         /* 软件版本,放大100倍,如1.00,表示为100 */

/* 系统数据保存基址 */
#define SYSTEM_PARA_SAVE_BASE       100         /* 系统信息保存首地址.从EEPROM的第100字节开始 */
...
extern const uint8_t APP_WKS_ICO6424[];         /* 启动界面图标,存放在flash */
extern const uint8_t APP_WKS_ICO12424[];        /* 启动界面图标,存放在flash */
extern const uint8_t APP_WKS_ICO8832[];         /* 启动界面图标,存放在flash */
extern const uint8_t APP_WKS_ICO16432[];        /* 启动界面图标,存放在flash */
extern const uint8_t APP_WKS_ICO12848[];        /* 启动界面图标,存放在flash */
extern const uint8_t APP_WKS_ICO24848[];        /* 启动界面图标,存放在flash */
...
void app_show_mono_icos(uint16_t x,uint16_t y,uint8_t width,uint8_t height,uint8_t *icosbase,uint32_t color,uint32_t bkcolor);
