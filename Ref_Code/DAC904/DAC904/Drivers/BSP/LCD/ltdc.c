...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef *hltdc)
{
    ...
    /* LTDC信号控制引脚 LTDC_DE(PF10), LTDC_VSYNC(PI9), LTDC_HSYNC(PI10), LTDC_CLK(PG7) */
    /* LTDC 数据引脚    LTDC_R7(PG6), LTDC_R6(PH12), LTDC_R5(PH11), LTDC_R4(PH10), LTDC_R3(PH9), LTDC_R2(PH8), LTDC_R1(PA2), LTDC_R0(PG13),
    ...
    gpio_init_struct.Alternate = GPIO_AF13_LTDC; /* 复用为LTDC */
