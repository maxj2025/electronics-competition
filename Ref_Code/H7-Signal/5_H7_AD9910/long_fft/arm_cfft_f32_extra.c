...
static void _arm_radix4_butterfly_f32_mve(const arm_cfft_instance_f32_extra * S,float32_t * pSrc, uint32_t fftLen)
{
...
static void arm_cfft_radix4by2_f32_mve(const arm_cfft_instance_f32_extra * S, float32_t *pSrc, uint32_t fftLen)
{
...
static void _arm_radix4_butterfly_inverse_f32_mve(const arm_cfft_instance_f32_extra * S,float32_t * pSrc, uint32_t fftLen, float32_t onebyfftLen)
{
    f32x4_t vecTmp0, vecTmp1;
    f32x4_t vecSum0, vecDiff0, vecSum1, vecDiff1;
    f32x4_t vecA, vecB, vecC, vecD;
...
static void arm_cfft_radix4by2_inverse_f32_mve(const arm_cfft_instance_f32_extra * S,float32_t *pSrc, uint32_t fftLen)
{
    float32_t const *pCoefVec;
    float32_t const  *pCoef = S->pTwiddle;
    float32_t        *pIn0, *pIn1;
...
extern void arm_bitreversal_32_extra(
        uint32_t * pSrc,
...
/**
  ...
  @code
                   const static arm_cfft_instance_f32_extra *S;
                   ...
                   switch (length) {
                     case 16:
...
void arm_cfft_radix8by2_f32_extra (arm_cfft_instance_f32_extra * S, float32_t * p1)
{
  uint32_t    L  = S->fftLen;
...
void arm_cfft_radix8by4_f32_extra (arm_cfft_instance_f32_extra * S, float32_t * p1)
{
