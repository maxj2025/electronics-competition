...
typedef struct
{
    ...
    /* void draw_hline(uint16_t x0,uint16_t y0,uint16_t len,uint32_t color) 画水平线函数 */
...
uint32_t rgb565torgb888(uint16_t rgb565);                                       /* 将RGB565转换为RGB888 */
uint32_t piclib_alpha_blend_agb888(uint32_t src, uint32_t dst, uint8_t alpha);  /* alphablend处理(RGB888颜色) */
