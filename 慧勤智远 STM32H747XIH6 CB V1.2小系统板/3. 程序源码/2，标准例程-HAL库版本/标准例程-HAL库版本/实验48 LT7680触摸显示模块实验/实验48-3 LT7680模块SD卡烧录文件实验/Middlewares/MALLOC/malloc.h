 ...
 * 以SRAMIN为例，size = 450 * 1024 + (450 * 1024 / 64) * 4 ≈ 478KB

 * 已知总内存容量(size)，最大内存池的计算公式如下：
 * MEMx_MAX_SIZE = (MEMx_BLOCK_SIZE * size) / (MEMx_BLOCK_SIZE + sizeof(MT_TYPE))
 * 以SRAM12为例,MEM3_MAX_SIZE = (64 * 256) / (64 + 4) = 240.94KB ≈ 240KB
 */
 
/* mem1内存参数设定.mem1是H7内部的AXI SRAM内存. */
#define MEM1_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM1_MAX_SIZE           450 * 1024                      /* 最大管理内存450K,H7的AXI内存总共512KB */
#define MEM1_ALLOC_TABLE_SIZE   MEM1_MAX_SIZE/MEM1_BLOCK_SIZE   /* 内存表大小 */

/* mem2内存参数设定.mem2的内存池处于外部SDRAM里面 */
#define MEM2_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM2_MAX_SIZE           22812 * 1024                    /* 最大管理内存22812K */
