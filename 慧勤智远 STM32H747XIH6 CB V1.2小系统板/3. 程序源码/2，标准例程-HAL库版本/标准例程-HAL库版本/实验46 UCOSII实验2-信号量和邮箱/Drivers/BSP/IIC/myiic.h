...
#define IIC_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */

#define IIC_SDA_GPIO_PORT               GPIOD
#define IIC_SDA_GPIO_PIN                GPIO_PIN_13
#define IIC_SDA_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOD_CLK_ENABLE(); }while(0)   /* PD口时钟使能 */
