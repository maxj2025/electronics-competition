...
static __align(64) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(0XD07E9000)));     /* 外部SDRAM内存池,前面大约8MB用作LTDC帧缓存(1080*1920*4) */
...
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0XD07E9000 + MEM2_MAX_SIZE)));  /* 外部SDRAM内存池MAP */
...
static __ALIGNED(64) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((section(".bss.ARM.__at_0XD07E9000")));  /* 外部SDRAM内存池 */
...
/* 内存管理表 */
static MT_TYPE mem1mapbase[MEM1_ALLOC_TABLE_SIZE];                                                          /* 内部SRAM内存池MAP */
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".bss.ARM.__at_0XD1E30000")));     /* 外部SDRAM内存池MAP */
