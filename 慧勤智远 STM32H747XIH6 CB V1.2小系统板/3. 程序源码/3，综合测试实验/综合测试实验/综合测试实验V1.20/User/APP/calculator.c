...
uint8_t calc_play(void)
{
    ...
    else
    {
        ...
        else if (lcddev.width == 320 || lcddev.height == 480 || lcddev.width == 1024)
        {
        ...
        else if (lcddev.width == 480 || lcddev.width == 720 || lcddev.width == 1280 || lcddev.height == 1280)        
        {
    ...
    if (rval == 0)
    {
        ...
        else if (lcddev.width == 320 || lcddev.height == 480 || lcddev.width == 1024)
        {
            ...
            if (lcddev.width == 1024) btnydis = 37;
            else btnydis = 18;
        }
        else if (lcddev.width == 480 || lcddev.width == 1280)
        {
            cdis->yoff = 50;
            cdis->width = 460;
            cdis->height = 110;
        ...
        if ((lcddev.width == 800 && lcddev.height == 480) || lcddev.width == 1024)
        {
            btnxdis = (320 - 5 * btnxsize) / 5;
            xoff = cdis->xoff - 10;
        }
        else if (lcddev.width == 1280)
        {
            btnxdis = (480 - 5 * btnxsize) / 5;   
            xoff = cdis->xoff - 10;                  
        }           
        else
        {
        ...
        for (i = 0; i < 6; i++)   /* 创建29个按钮 */
        {
            for (j = 0; j < 5; j++)
            {
                ...
                if (i < 2)
                {
                    c_btn[res] = btn_creat(j * (btnxsize + btnxdis) + btnxdis / 2 + xoff, i * (mbtnysize + btnydis) + gui_phy.tbheight + cdis->yoff * 2 + cdis->height + (mbtnysize - fbtnysize) / 2, btnxsize, fbtnysize, 0, 2); /* 创建圆角按钮 */
                ...
                {
                    c_btn[res] = btn_creat(j * (btnxsize + btnxdis) + btnxdis / 2 + xoff, i * (mbtnysize + btnydis) + gui_phy.tbheight + cdis->yoff * 2 + cdis->height, btnxsize * 2 + btnxdis, mbtnysize, 0, 2); /* 创建圆角按钮 */
                    c_btn[res]->bkctbl[0] = BLACK;  /* 边框颜色 */
                ...
                {
                    c_btn[res] = btn_creat(j * (btnxsize + btnxdis) + btnxdis / 2 + xoff, i * (mbtnysize + btnydis) + gui_phy.tbheight + cdis->yoff * 2 + cdis->height, btnxsize, mbtnysize, 0, 2); /* 创建圆角按钮 */
