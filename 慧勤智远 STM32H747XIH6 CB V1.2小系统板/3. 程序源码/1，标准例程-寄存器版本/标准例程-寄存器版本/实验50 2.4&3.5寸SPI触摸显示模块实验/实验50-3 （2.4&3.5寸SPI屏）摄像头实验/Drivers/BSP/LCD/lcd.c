 ...
 * @file        lcd.c
 * @version     V1.0
 * @brief       2.4寸/3.5寸 TFTLCD(SPI串口屏) 驱动代码	
 *              支持驱动IC型号包括:ST7796/ST7789
 ****************************************************************************************************
...
uint16_t lcd_read_point(uint16_t x, uint16_t y)
{
    ...
    lcd_spi_speed_low();          /* 降低SPI时钟频率，驱动IC读数据的时候速度不能太快 */
    
    lcd_opt_delay(2);  
    color = lcd_read_ram(0X2E);   /* 7796/7789发送读GRAM指令 */
