...
{    
    ...
    sys_gpio_set(TFT_SPI_CS_GPIO_PORT, TFT_SPI_CS_GPIO_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_HIGH, SYS_GPIO_PUPD_PU);   /* TFT_SPI_CS引脚模式设置(推挽输出) */
                 
    sys_gpio_set(TFT_SPI_SCL_GPIO_PORT, TFT_SPI_SCL_GPIO_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_HIGH, SYS_GPIO_PUPD_PU);   /* TFT_SPI_SCL引脚模式设置(推挽输出) */

    sys_gpio_set(TFT_SPI_SDA_GPIO_PORT, TFT_SPI_SDA_GPIO_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_HIGH, SYS_GPIO_PUPD_PU);   /* TFT_SPI_SDA引脚模式设置(推挽输出) */

    sys_gpio_set(TFT_SPI_RST_GPIO_PORT, TFT_SPI_RST_GPIO_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_HIGH, SYS_GPIO_PUPD_PU);   /* TFT_SPI_RST引脚模式设置(推挽输出) */
