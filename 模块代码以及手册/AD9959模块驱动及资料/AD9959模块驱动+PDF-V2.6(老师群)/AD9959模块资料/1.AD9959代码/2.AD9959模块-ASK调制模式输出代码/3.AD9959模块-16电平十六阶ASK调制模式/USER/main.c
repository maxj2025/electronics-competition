/**********************************************************
                       康威电子
功能：stm32f103rct6控制AD9959模块16电平十六阶ASK调制模式
...
//	本函数只能选择CH0做16电平调制，未做任意通道兼容，具体方法请参考AD9959芯片手册22-23页，操作FR1[14:12]为对应值。
	...
	while(1)
	{
		PS0=0;PS1=0;PS2=0;PS3=0;//PS0-PS3控制CH0；CH0输出幅度1
		delay_ms(10);
		
		PS0=0;PS1=0;PS2=0;PS3=1;//CH0输出幅度2
		delay_ms(10);
		
		PS0=0;PS1=0;PS2=1;PS3=0;//CH0输出幅度3
		delay_ms(10);
		
		PS0=0;PS1=0;PS2=1;PS3=1;//CH0输出幅度4
		delay_ms(10);		
		
		PS0=0;PS1=1;PS2=0;PS3=0;//CH0输出幅度5
		delay_ms(10);
		
		PS0=0;PS1=1;PS2=0;PS3=1;//CH0输出幅度6
		delay_ms(10);
	
		PS0=0;PS1=1;PS2=1;PS3=0;//CH0输出幅度7
		delay_ms(10);
		
		PS0=0;PS1=1;PS2=1;PS3=1;//CH0输出幅度8
		delay_ms(10);
		
		PS0=1;PS1=0;PS2=0;PS3=0;//CH0输出幅度9
		delay_ms(10);
		
		PS0=1;PS1=0;PS2=0;PS3=1;//CH0输出幅度10
		delay_ms(10);
		
		PS0=1;PS1=0;PS2=1;PS3=0;//CH0输出幅度11
		delay_ms(10);
		
		PS0=1;PS1=0;PS2=1;PS3=1;//CH0输出幅度12
		delay_ms(10);		
		
		PS0=1;PS1=1;PS2=0;PS3=0;//CH0输出幅度13
		delay_ms(10);
		
		PS0=1;PS1=1;PS2=0;PS3=1;//CH0输出幅度14
		delay_ms(10);
	
		PS0=1;PS1=1;PS2=1;PS3=0;//CH0输出幅度15
		delay_ms(10);
		
		PS0=1;PS1=1;PS2=1;PS3=1;//CH0输出幅度16
		delay_ms(10);
	}
